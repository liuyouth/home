<template>
    <div ref="el" :style="style" style="width: 320px;" class="widget">
        ...
        没有添加的按键，一切都是快捷键操作！
        <br>
        以下是快捷键列表<br><br>（由于技术原因快捷键<span>Alt</span>需要最后按才可以🌚 知道如何解决的朋友可以私信）
        <br><br>
        需要添加widget的时候按 <span>A</span> +<span>D</span>+<span>Alt</span>
        <br><br>
        需要添加widget的时候按 <span></span> +<span>A</span>+<span>Alt</span>
        <br><br>
        需要需要帮助的时候按 <span>H</span> +<span>Alt</span>
        <br>
        👋 Drag me!
    </div>
</template>
